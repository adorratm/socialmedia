      ...
      <nav class="hk-nav hk-nav-light">
        ...
        <div class="nicescroll-bar">
          <div class="navbar-nav-wrap">
            ...
            <li class="nav-item" >
                <nuxt-link to="/panel/"  exact exact-active-class="active" class="nav-link">Dashboard</nuxt-link>
            </li>
          ...
          <div class="settings-panel-wrap">
            ...
            <div class="button-list hk-nav-select mb-10">
              <button
                ...
                id="nav_light_select"
                class="
                  btn btn-outline-primary btn-sm btn-wth-icon
                  icon-wthot-bg
                "
              >
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div
                class="
                  toggle toggle-sm toggle-simple toggle-light toggle-bg-primary
                  scroll-nav-switch
                "
              ></div>
            </div>
            <button
              id="reset_settings"
              class="btn btn-primary btn-block btn-reset mt-30"
            >
              Reset
            </button>
          </div>
        </div>
        <img class="d-none" src="/vendor/img/logo-light.png" alt="brand" />
        <img class="d-none" src="/vendor/img/logo-dark.png" alt="brand" />
      </div>
      <!-- /Setting Panel -->
    </div>
  </client-only>
